defmodule Puls8Web.UserAuthTest do
  use Puls8Web.ConnCase, async: true

  alias Phoenix.LiveView
  alias Puls8.Accounts
  alias Puls8Web.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, Puls8Web.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      Puls8Web.Endpoint.subscribe(live_socket_id)
